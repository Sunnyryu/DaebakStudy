...
function setAppMenu() {
    ...
    const template = [
        ...
        },
        {
            label: "Edit",
            submenu: [
                { label: "Copy", accelrator:"CmdOrCtrl+C", role: "copy"},
                { label: "Paste", accelrator:"CmdOrCtrl+V", role: "paste"},
                { label: "Cut", accelrator:"CmdOrCtrl+X", role: "cut"},
                { label: "Select All", accelrator:"CmdOrCtrl+A", role: "selectall"},
            ]
        },
        {
            label: "View",
